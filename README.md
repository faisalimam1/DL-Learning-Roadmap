...
![Progress](https://img.shields.io/badge/Progress-Day%2015%20of%2030-blue?style=for-the-badge)
...
| ✅ Day 13 | NLP Evaluation Metrics | F1 · ROUGE · BLEU · Perplexity | Partial summary beat good summary on ROUGE-2 (0.381 vs 0.351) — exact copy scores 1.000 | [View](./phase-2-huggingface/Phase-2-DL-HuggingFace.ipynb) |
| ✅ Day 14 | Sentence Transformers | Embeddings · Cosine Similarity · Semantic Search | Built 8-line semantic search engine — king↔monarch=0.736, king↔bicycle=0.275 | [View](./phase-2-huggingface/Phase-2-DL-HuggingFace.ipynb) |
| ✅ Day 15 | LoRA & PEFT | Efficient Fine-tuning · QLoRA | 0.65% trainable params (811k/125M) · 99.3% storage saving · 3.1MB adapter vs 475MB model | [View](./phase-2-huggingface/Phase-2-DL-HuggingFace.ipynb) |
...
| Fine-tuning BERT | F1: 0.921 on IMDB — 20k train, 3 epochs, lr=2e-5, T4 GPU — model live at [huggingface.co/faisalimam19/bert-imdb-sentiment](https://huggingface.co/faisalimam19/bert-imdb-sentiment) |
| BERT Failure Mode | Sarcasm: "truly masterful... put me to sleep" → POSITIVE 0.976 — BERT reads words not intent |
| NLP Metrics | ROUGE-2 paradox: partial summary (0.381) beat good summary (0.351) — exact copy scores 1.000 |
| Perplexity | Simulation PPL 1.12 vs real GPT-2 ~18-29 — same formula, completely different scale (5 tokens vs 50,257) |
| Semantic Search | Built retrieval engine in 8 lines — vocabulary gap: "AI systems using real documents" → RAG scored only 0.365 |
| LoRA | GPT-2 fine-tuned with 0.65% parameters (811k/125M) — adapter 3.1MB vs full model 475MB = 99.3% storage saving |
